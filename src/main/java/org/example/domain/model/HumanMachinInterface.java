...
public class HumanMachinInterface {
    ...
    public int readNcolOrNRows(String instructionText) {  //This method returns True if player wants to play new game
    ...
    public void setHashCodeListForPlayerChosenPos() {
        ...
        hashCodeList.clear();
        pos = readCardPos("first");   hashCodeList.add(gameStatus.calcHashCodePos(pos));
        pos = readCardPos( "second");  hashCodeList.add(gameStatus.calcHashCodePos(pos));
    }
